...
const VehicleCard = ({ vehicle, onBook }) => {
  return (
    <div className="group bg-card rounded-3xl overflow-hidden border border-white/5 hover:border-primary/50 transition-all duration-300 hover:shadow-2xl hover:shadow-primary/10 flex flex-col h-full cursor-pointer" onClick={(e) => { e.stopPropagation(); onBook(vehicle); }}>
      {/* Image Container */}
