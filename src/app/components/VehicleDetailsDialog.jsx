...
export function VehicleDetailsDialog({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Dialog Content */}
      <div className="relative w-full max-w-6xl bg-[#0f0f1a] border border-white/10 rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row h-[90vh] animate-in zoom-in-95 duration-300">
        ...
        <div className="w-full md:w-[60%] p-6 md:p-8 overflow-y-auto custom-scrollbar">
          {/* Header Mobile Only */}
        ...
        <div className="w-full md:w-[40%] bg-[#151520] border-l border-white/10 flex flex-col h-full overflow-hidden">
