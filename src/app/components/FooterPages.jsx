...
export const About = () => (
    <PageLayout title="About Wheelio" subtitle="Redefining the car rental experience with premium service and luxury vehicles.">
        <div className="space-y-8 text-gray-300 leading-relaxed text-lg">
            ...
            <div>
                <h3 className="text-2xl font-bold text-white mb-4">Why Coimbatore?</h3>
                <p>
                    Headquartered in the Manchester of South India, Coimbatore, we are strategically placed to serve the gateways of the Nilgiris. Whether you are planning a corporate trip to the textile hubs or a leisure drive to Ooty and Valparai, our fleet is ready.
                </p>
            </div>
...
export const HelpCenter = () => {
    ...
    const handleSend = (e) => {
        ...
        setTimeout(() => {
            ...
            if (userMsg.toLowerCase().includes('price') || userMsg.toLowerCase().includes('cost')) reply = "Our prices start from ₹1500/day for bikes and ₹2500/day for cars.";
            if (userMsg.toLowerCase().includes('document') || userMsg.toLowerCase().includes('license')) reply = "You need a valid Driving License and Aadhar card.";
            if (userMsg.toLowerCase().includes('cancel')) reply = "Cancellations are free up to 24 hours before the trip.";
